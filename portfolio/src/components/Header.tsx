...
export const Header: React.FC = () => {
  return (
    <header role="banner" className="sticky top-0 z-50 bg-white/80 backdrop-blur border-b border-slate-200">
      <div className="container-responsive flex h-16 items-center justify-between">
        <a href="#hero" className="font-semibold text-primary">NE</a>
